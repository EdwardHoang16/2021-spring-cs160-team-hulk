...
public class OrganicFarmApplication {
	...
	public class DataLoader implements ApplicationRunner {
		...
		@Autowired
		public DataLoader(UserCredentialsRepository userCredentialsRepository, FarmRepository farmRepository) {
